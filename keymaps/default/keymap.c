 ...
 */
    [MAC] = KEYMAP(
        ...
        KC_LSFT,             KC_Z ,   KC_X ,   KC_C ,   KC_V ,   KC_B ,   KC_N ,   KC_M , KC_COMM,  KC_DOT, KC_SLSH,          KC_F14,  KC_UP ,       KC_P1 ,  KC_P2 ,  KC_P3 ,         \
        KC_CAPS,    KC_LOPT,    KC_LCTL,   MO(MAC_FN),        KC_SPC,           KC_RSFT,    KC_ROPT,    KC_RCTL,    KC_RCMD, KC_LEFT, KC_DOWN,      KC_RGHT,  KC_P0 , KC_PDOT, KC_PENT ),
    ...
    [MAC_FN] = KEYMAP(
        ...
        _______,    LCMD(KC_W), _______,    KC_F15,     KC_F17,     _______,    KC_DEL,     KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_BSPC,    _______,    _______,    _______,    _______,    _______,    _______,\
        _______,    LCA(KC_Z),  KC_F18,     _______,    KC_F16,     _______,    LOPT(KC_LEFT),          LOPT(KC_RGHT),          _______,    _______,    _______,    _______,    KC_VOLU,    _______,    _______,    _______,\
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    LCTL(KC_LEFT),          KC_VOLD,    LCTL(KC_RGHT),          _______,    _______,    _______ ),
