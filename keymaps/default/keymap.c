...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi(
        QK_BOOT,    DF(MAC),    DF(WIN),    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_NLCK,    KC_PSCR,    KC_F20,     KC_F21,\
        ...
        _______,    LCMD(KC_W), KC_F18,     LCA(KC_D),  KC_F17,     _______,    KC_DEL,     KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_BSPC,    _______,    _______,    _______,    _______,    _______,    _______,\
        _______,    LCA(KC_Z),  KC_F19,     KC_F20,     KC_F16,     _______,    LOPT(KC_LEFT),          LOPT(KC_RGHT),          _______,    _______,    _______,    _______,    KC_VOLU,    _______,    _______,    _______,\
    ...
    [WIN_FN] = LAYOUT_ansi(
        QK_BOOT,    DF(MAC),    DF(WIN),    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_NLCK,    KC_PSCR,    KC_F20,     KC_F21,\
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_HOME,    KC_END,     KC_PGUP,    KC_PGDN,\
        LSFT(LGUI(KC_LEFT)),    KC_F13,     LCTL(KC_F18),           LGUI(KC_E), LCTL(LSFT(KC_ESC)),     _______,    _______,    KC_HOME,    KC_UP,      KC_END,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,\
        ...
        _______,    KC_F18,     LSFT(KC_F18),           LGUI(KC_1), KC_F16,     _______,    KC_PGUP,    KC_PGDN,    _______,    _______,    _______,    _______,    KC_VOLU,    _______,    _______,    _______,\
        _______,    _______,    _______,    _______,    KC_F20,    _______,    _______,    _______,    _______,    LCTL(LGUI(KC_LEFT)),    KC_VOLD,    LCTL(LGUI(KC_RGHT)),    _______,    _______,    _______ ),
};
